...
object RecommendationEngine {
    ...
    fun generarRecomendaciones(student: FirebaseStudent): List<String> {
        ...
        if (tiempoProm > 0.0) {
            when {
                tiempoProm > 20.0 -> {
                    recomendaciones.add("Tómate tu tiempo, pero intenta agilizar tus cálculos mentales para responder un poquito más rápido.")
                }
        ...
        when {
            ...
            racha in 2..4 -> {
                recomendaciones.add("¡Mantén encendido tu fuego de estudio! Llevas $racha días practicando seguidos.")
            }
            racha == 0 -> {
